...
Shader "Shader Forge/oy_GlassSphere_Forward" {
    Properties {
...
////// Specular:
                ...
                float4 node_7157 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture, ((node_8313*sceneUVs.rg)+((sceneUVs.rg+(node_923.rg*node_5222))*_Use_Distortion))); //for Single Pass Instancing
